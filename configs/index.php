...
<p>Since I use /DATA for a lot of my files, I changed <a href=".config/user-dirs.dirs">.config/user-dirs.dirs</a> file to point to directories in /DATA.</p>
<h2>.nethackrc</h2>
