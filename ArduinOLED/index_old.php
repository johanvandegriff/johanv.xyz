...
<p>ArduinOLED is a platform for electronic games and other projects. It includes an OLED screen, a joystick, some buttons, a buzzer, and alligator clip connection points to interface with many other devices. You can see the <a target="_blank" href="https://easyeda.com/jjvan/OLED_Arduino-55422f17ec8149338d246987e5e87bc4">board design on EasyEDA</a>. <br /></p>
<p>If you have a question, comment, or project you made with this board, email <?php hideEmail("johanvandegriff@gmail.com", "[click to show]")?>. I would love to add your project to this site.</p>
<h2 style="text-align: center;">Project Ideas<br /></h2>
<ul>
  <li>Battery load tester for FTC like <a href="https://www.andymark.com/battery-beak-p/am-batterybeak.htm">this one from AndyMark.</a></li>
  <li>Games such as whack-a-mole, pong, snake, stacker, connect 4, tic-tac-toe, tetris, asteroids</li>
</ul>
...
<img style="width: 100%" src="http://johan.vandegriff.net/ArduinOLED/DownloadIDE.png" />
...
<p><img style="width: 100%" src="http://johan.vandegriff.net/ArduinOLED/Allow.png" />
</p>
<p><br /></p>
<a id="Libraries">
...
<p><img style="width: 100%" src="http://johan.vandegriff.net/ArduinOLED/ManageLibraries.png" /></p>
<p>Type "U8g2" in the search bar and click "Install".<br /></p>
<p><img style="width: 100%" src="http://johan.vandegriff.net/ArduinOLED/U8g2Download.png" /></p>
...
<div data-ephox-embed-iri="https://github.com/mmarchetti/DirectIO" style="border: 1px solid rgb(170, 170, 170); box-shadow: 0px 2px 3px rgba(0, 0, 0, 0.3); padding: 10px; overflow: hidden; margin-bottom: 1em; max-width: 500px;">
  <a href="https://github.com/mmarchetti/DirectIO" style="text-decoration: none; color: inherit;">
    <img src="https://avatars0.githubusercontent.com/u/2903390?v=4&amp;s=400" style="max-width: 180px; max-height: 180px; margin-left: 2em; float: right;" />
  </a>
  <a href="https://github.com/mmarchetti/DirectIO" style="text-decoration: none; color: inherit;">
...
<p><img style="width: 100%" src="http://johan.vandegriff.net/ArduinOLED/ZipLibrary.png" /></p>
...
<div data-ephox-embed-iri="https://github.com/johanvandegriff/ArduinOLED" style="border: 1px solid rgb(170, 170, 170); box-shadow: 0px 2px 3px rgba(0, 0, 0, 0.3); padding: 10px; overflow: hidden; margin-bottom: 1em; max-width: 500px;">
  <a href="https://github.com/johanvandegriff/ArduinOLED" style="text-decoration: none; color: inherit;">
    <img src="https://avatars1.githubusercontent.com/u/18060905?v=4&amp;s=400" style="max-width: 180px; max-height: 180px; margin-left: 2em; float: right;" />
  </a>
  <a href="https://github.com/johanvandegriff/ArduinOLED" style="text-decoration: none; color: inherit;">
...
<img style="width: 100%" src="http://johan.vandegriff.net/ArduinOLED/ProgrammerCable.JPG">
...
<img style="width: 100%" src="http://johan.vandegriff.net/ArduinOLED/WithCable.JPG">
...
<p><img style="width: 100%" src="http://johan.vandegriff.net/ArduinOLED/StackerExampleSketch.png" /></p>
<p>Hold down the button labelled "RST" on the ArduinOLED board:</p>
<img style="width: 100%" src="http://johan.vandegriff.net/ArduinOLED/ResetButton.JPG">
<p>Click the "Upload" button:</p>
<img style="width: 100%" src="http://johan.vandegriff.net/ArduinOLED/Upload.png">
<p>When the status changes from "Compiling..." and "Uploading...", release the "RST" button.</p>
<p>Text should appear on the screen:</p>
<img style="width: 100%" src="http://johan.vandegriff.net/ArduinOLED/StackerMenu.JPG">
