<?php $pageName = "ArduinOLED"; $pageNameExtra = "Tutorial"; $image = "https://johanv.xyz/ArduinOLED/StackerMenu.JPG"; $description = "A platform for electronic games and other projects. It includes a screen, joystick, buttons, buzzer, and clip connections to add many other devices."; include $_SERVER['DOCUMENT_ROOT'].'/header.php'; ?>
